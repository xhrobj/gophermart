...
CREATE TYPE order_status AS ENUM (
    ...
    'INVALID', -- Внешний сервис отказал в расчёте; финальный статус
    'PROCESSED' -- Расчет завершён; финальный статус
);
```
...
Оптимизирует выбор заказов, которые пора отправить во внешний сервис accrual. Пранируется использовать в запросе poller'а.
